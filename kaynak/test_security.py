...
def test_i18n():
    ...
    try:
        sm.set_lang("en")
        check("EN pencere adi", sm.tr("SistemMonitor") == "SistemMonitor", f"(={sm.tr('SistemMonitor')})")
        ...
        check("EN html title", "SistemMonitor - Phone" in html)
        ...
        sm.set_lang("tr")
        check("TR pencere adi", sm.tr("SistemMonitor") == "SistemMonitor")
        ...
        sm.set_lang("unknown")
        check("Bilinmeyen dil TR fallback", sm.tr("SistemMonitor") == "SistemMonitor")
    finally:
        sm.set_lang(orig)
